    ...
    <div className="min-h-screen bg-white dark:bg-secondary-900 text-secondary-900 dark:text-white overflow-hidden">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-primary-600 to-primary-800 dark:from-primary-800 dark:to-secondary-900">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="mt-6 text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              We provide powerful, intuitive tools that help teams collaborate efficiently, meet deadlines, and achieve their goals together.
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" className="fill-white dark:fill-secondary-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className={`max-w-4xl mx-auto mb-12 transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Mission Tab */}
          <div className={`transition-all duration-500 ${activeTab === 'mission' ? 'block opacity-100' : 'hidden opacity-0'}`}>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start">
                        ...
                        <p className="ml-3 text-secondary-700 dark:text-secondary-300">{point}</p>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          {/* Team Tab */}
          <div className={`transition-all duration-500 ${activeTab === 'team' ? 'block opacity-100' : 'hidden opacity-0'}`}>
            <div className="bg-white dark:bg-secondary-800 rounded-2xl shadow-lg overflow-hidden p-8 sm:p-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={index} className="flex flex-col items-center text-center">
                    ...
                    />
                    <h3 className="text-xl font-semibold text-secondary-900 dark:text-white">{member.name}</h3>
              ...
              <div className="mt-16 text-center">
                <h3 className="text-2xl font-semibold mb-6 text-secondary-900 dark:text-white">Backed by a Team of Experts</h3>
                <p className="text-secondary-700 dark:text-secondary-300 max-w-2xl mx-auto">
                  Our full team includes talented engineers, designers, product managers, and customer success specialists all committed to making your task management experience exceptional.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Technology Tab */}
          <div className={`transition-all duration-500 ${activeTab === 'technology' ? 'block opacity-100' : 'hidden opacity-0'}`}>
            <div className="bg-white dark:bg-secondary-800 rounded-2xl shadow-lg overflow-hidden">
              <div className="p-8 sm:p-10">
                <h2 className="text-3xl font-bold mb-8 text-secondary-900 dark:text-white">Our Technology Stack</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                  <div>
                    ...
                    <p className="text-secondary-700 dark:text-secondary-300 leading-relaxed">
                      Our platform is built using a modern microservices architecture, ensuring scalability, reliability, and fast performance. We employ continuous integration and delivery practices to ship new features and improvements regularly.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold mb-4 flex items-center text-secondary-900 dark:text-white">
                    ...
                    <p className="text-secondary-700 dark:text-secondary-300 leading-relaxed">
                      Security is at the core of our development process. We implement industry best practices for data protection, regular security audits, and comply with privacy regulations to ensure your data is always safe.
                    </p>
                  </div>
                </div>
                
                <h3 className="text-xl font-semibold mb-6 text-secondary-900 dark:text-white">Technology Stack</h3>
                
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {[
                    "React", "Node.js", "MongoDB", "Redis",
                    "WebSockets", "Docker", "AWS", "TailwindCSS"
                  ].map((tech, index) => (
                    <div key={index} className="bg-secondary-50 dark:bg-secondary-700/30 rounded-lg p-4 text-center">
                      <span className="font-medium text-secondary-800 dark:text-secondary-200">{tech}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 dark:from-secondary-800 dark:to-secondary-900 p-8 sm:p-10 border-t border-secondary-200 dark:border-secondary-700">
                ...
                <p className="text-secondary-700 dark:text-secondary-300 mb-6 leading-relaxed">
                  Our product roadmap is guided by user feedback and industry trends. We're constantly exploring new technologies and approaches to improve your experience.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {[
                    {
                      title: "AI-Powered Insights",
                      description: "Exploring machine learning to provide task prioritization suggestions."
                    },
                    {
                      title: "Enhanced Integrations",
                      description: "Expanding our ecosystem with more third-party integrations."
                    },
                    {
                      title: "Mobile Experience",
                      description: "Continually improving our responsive design for all devices."
                    }
                  ].map((item, index) => (
                    <div key={index} className="bg-white dark:bg-secondary-700 rounded-lg p-5 shadow-sm">
                      <h4 className="font-semibold mb-2 text-secondary-900 dark:text-white">{item.title}</h4>
                      <p className="text-sm text-secondary-600 dark:text-secondary-400">{item.description}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {/* Values Tab */}
          <div className={`transition-all duration-500 ${activeTab === 'values' ? 'block opacity-100' : 'hidden opacity-0'}`}>
            <div className="bg-white dark:bg-secondary-800 rounded-2xl shadow-lg overflow-hidden p-8 sm:p-10">
              <h2 className="text-3xl font-bold mb-10 text-secondary-900 dark:text-white text-center">Our Core Values</h2>
                ...
                {[
                  {
                    icon: <FaUsers />,
                    title: "Users First",
                    description: "Every decision we make starts with the question: 'How does this benefit our users?' We're committed to creating tools that genuinely solve problems."
                  },
                  {
                    icon: <FaLightbulb />,
                    title: "Innovation",
                    description: "We embrace creativity and aren't afraid to challenge convention. We're constantly seeking better ways to help teams work together."
                  },
                  {
                    icon: <FaShieldAlt />,
                    title: "Trust & Security",
                    description: "We treat your data with the utmost care. Building and maintaining trust is fundamental to everything we do."
                  },
                  {
                    icon: <FaClock />,
                    title: "Efficiency",
                    description: "We value your time. Our platform is designed to reduce busywork and help teams focus on what truly matters."
                  }
                ].map((value, index) => (
                  <div key={index} className="bg-secondary-50 dark:bg-secondary-700/30 rounded-xl p-6 flex">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-3 text-secondary-900 dark:text-white">{value.title}</h3>
                      <p className="text-secondary-700 dark:text-secondary-300">{value.description}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <div className="bg-gradient-to-r from-primary-500 to-primary-700 dark:from-primary-800 dark:to-primary-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <div className={`max-w-3xl mx-auto transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Ready to Transform Your Team's Productivity?
            </h2>
            <p className="text-xl text-white/80 mb-8">
              Join thousands of teams who've improved their workflow with our platform.
            </p>
            <a 
              href="/login" 
