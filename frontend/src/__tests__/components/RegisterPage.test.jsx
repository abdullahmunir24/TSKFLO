...
describe('RegisterPage Component', () => {
  ...
  it('should toggle password visibility when eye icon is clicked', () => {
    ...
    const confirmPasswordSection = screen.getByText('Confirm Password').closest('div');
    ...
    const confirmPasswordToggleButton = confirmPasswordSection.querySelector('button');
