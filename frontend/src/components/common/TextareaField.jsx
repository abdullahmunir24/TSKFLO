...
/**
 * Reusable textarea field with character counter
 */
const TextareaField = ({
  id,
  name,
  ...
  return (
    <div className={className}>
      ...
      <textarea
        ...
        } bg-white dark:bg-secondary-800 text-secondary-900 dark:text-white placeholder-secondary-400 dark:placeholder-secondary-500 resize-y`}
      />
